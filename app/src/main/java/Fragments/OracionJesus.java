...
public class OracionJesus extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.oracionjesus,
                container, false);

        WebView texto = (WebView)view.findViewById(R.id.oracionJesustext);
        ...
        texto.loadData(getString(R.string.oracionjesus), "text/html", "UTF-8");
