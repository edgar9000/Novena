...
public class OracionALaVirgen extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.oracionvirgen,
                container, false);

        WebView texto = (WebView)view.findViewById(R.id.oracionVirgentext);
        ...
        texto.loadData(getString(R.string.oracionvirgen), "text/html", "UTF-8");
